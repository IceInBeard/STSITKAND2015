...
Vill du göra felrapporteringar via din mobil? Ladda ner vår app <i>Felrapportering Uppsala</i>!
			...
			<p class="idag-container"> 
				<span class="amountToday">
				<?php include 'db/todaysBikes.php'; ?></span>
				antal cyklister idag 
			</p>
			
			<p class="idag-container"> 
				Totalt
				<span class="amountToday">
				<?php include 'db/todaysIssues.php'; ?></span>
				lösta felrapporteringar
			...
			<p class="idag-container"> 
				<span class="amountToday">
				<?php include 'db/todaystweets.php'; ?></span>
				tweets om Uppsala idag
			</p>
