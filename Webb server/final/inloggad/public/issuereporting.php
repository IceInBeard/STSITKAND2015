...
<table class="edit-table">
  ...
  <tr>
    <td>Kategori:</td>
    <td><div id="categorySelect2"><input id="category-textbox2" type="text" ></td></div></td>
  </tr>
  <tr>
    <td>Lokalisering: </td>
...
<input id="thisMarkerId-textbox" type="text" style="display:none;">
  ...
  <button id="createCompButton" onclick="createCompany()">Klar</button>
   </div>
  <h2> Ta bort ett företag</h2>
<table class="edit-table">
<tr>
<td>Företagsnamn:</td>
 <td id="companyDropdown"></td>
  </tr>
  </table>
  <div id="editBoxButton" >

  <button id="deleteCompButton" onclick="deleteCompany()">Ta bort</button>
   </div>
...
<table id="edit-table">
  ...
  <tr>
    <td>Kategori:</td>
    <td><div id="categorySelect"><input id="category-textbox" type="text" ></td></div></td>
  </tr>
  ...
  <div id="editBoxButton" >
  <button id= "removeIssueButton" onclick="removeIssue()"> Ta bort ärende </button>
...
<button id="NewCompButton" onclick="loadNewCompany()" class="fancybox fancybox.inline" href="#newCompany"> Hantera företag </button> 
</div>
      </div>
