...
function regformhash(form, uid, email, password, conf, admin) {
    ...
    if(!re.test(form.username.value)) { 
        alert("Användarnamnet får endast innehålla bokstäver och mellanslag. Var vänlig försök igen"); 
        form.username.focus();
        return false; 
    }
...
function regformhashAdminChangePass(form, password, conf) {
     // Check each field has a value
...
function regformhashService(form, title, message, starttime, stoptime, close) {
     // Check each field has a value

     var startTimestamp = new Date(starttime.value);
     var stopTimestamp = new Date(stoptime.value);
    ...
    if(!re.test(form.title.value)) { 
        alert("Titeln innehåller ogiltiga tecken."); 
        form.title.focus();
        return false; 
    }

    if(startTimestamp.getTime()>stopTimestamp.getTime()){
        alert("Sluttiden måste vara efter starttiden."); 
        return false; 
    }else {
       // starttime.value = startTimestamp.getTime();
       // stoptime.value = stopTimestamp.getTime();
    }
