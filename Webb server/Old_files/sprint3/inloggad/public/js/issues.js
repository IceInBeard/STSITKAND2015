...
function changeAll(){
	...
	//var selectbox = document.getElementById("category").value;
 	//var chosenCategory= selectbox.options[selectbox.selectedIndex].value;
...
function loadListIssues(categories){
	...
	//onclick på knappen 
	$("div.nav").html('<button id="filterButton" onclick="loadFilter()" class="fancybox fancybox.inline" href="#filter"> Filtrera listan </button>');
