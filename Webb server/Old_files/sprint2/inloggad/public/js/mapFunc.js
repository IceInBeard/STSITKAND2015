...
function markersToMap(category) {
		...
		}else if (markers[i].status == "Fixad"){
			
			
			
			var icon2 = 'http://stsitkand.student.it.uu.se/issuereporting/images/green/'+markers[i].category + "GREEN.svg"; //För att en marker ska få rätt ikon efter kategori måste bildfilen heta sin kategori och vara i png-format.
		}
		else if (markers[i].status == "Inrapporterad"){
			  
			
			var icon2 = 'http://stsitkand.student.it.uu.se/issuereporting/images/red/'+markers[i].category + "RED.svg"; //För att en marker ska få rätt ikon efter kategori måste bildfilen heta sin kategori och vara i png-format.
		}
		else {
			
			
			var icon2 = 'http://stsitkand.student.it.uu.se/issuereporting/images/yellow/'+markers[i].category + "YELLOW.svg"; //För att en marker ska få rätt ikon efter kategori måste bildfilen heta sin kategori och vara i png-format.
		}
