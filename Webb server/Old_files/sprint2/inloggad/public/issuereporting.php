...
<div id="filter" ><!--Här är hela den stora rutan-->
		<div class="leftSide"><!--Här är alla övergripande kategorier-->
			<ul>
				...
				<li class="leftSideColor" id="leftSideDescription">Beskrivning</li>
...
<li>
              <input checked onclick="switchCheckbox2(this)" id="option9" type="checkbox" value="Övrigt" >
				...
				<li><input id="checkStatusFixed" type="checkbox" onlick="switchCheckbox2(this)" value="statusFixed" checked=""  ></input> Fixad</li>
				<li>  <input id="checkStatusUnfixed" type="checkbox" onlick="switchCheckbox2(this)" value="statusUnfixed" checked=""></input> Inrapporterad</li>
				<li>  <input id="checkStatusOngoing" type="checkbox" onlick="switchCheckbox2(this)" value="statusOngoing" checked=""></input> Under Behandling</li></ul>

				<ul id="rightSideDescription">
				<li>  <input id="checkDescriptionShow" type="checkbox" onlick="switchCheckbox2(this)" value="checkDescriptionShow" checked=""></input> Visa beskrivning</li></ul>

				<ul id="rightSideDate">
				<li>  <input id="checkDateShow" type="checkbox" onlick="switchCheckbox2(this)" value="checkDateShow" checked=""></input>Visa datum</li></ul>

				<ul id="rightSideComment">
				<li>  <input id="checkCommentShow" type="checkbox" onlick="switchCheckbox2(this)" value="checkCommentShow" checked=""></input> Visa kommentarer</li></ul>
			</div>
		</div>
...
<table id="edit-table">
  ...
  <tr>
    <td>Status: </td>
    <td><!---<input id="status-textbox" type="text" >--->
	<select id='status2'><option>Fixad</option><option>Under behandling</option> <option>Inrapporterad</option></select></td>
  </tr>
  <tr>
    <td>Kategori:</td>
    <td><!--<input id="category-textbox" type="text" >--->
	<select id='status1'><option>Fixad</option><option>Under behandling</option> <option>Inrapporterad</option></select>
</td>
  </tr>
  <tr>
    <td>Kommentar: </td>
  ...
  <tr>
    <td>Namn: </td>
    <td><input id="name-textbox" type="text" ></td>
  </tr>
  <tr>
    <td>Email: </td>
  ...
  <tr>
    <td>Företag: </td>
    <td><!--<input id="company-textbox" type="text" >---> 
        <select id='company1'><option>Företag 1</option><option>Företag 2</option> <option>Företag 3</option></select></td>
  </tr>
</table>
  <div id="editBoxButton" >
...
<div class="contact-info">
   <div class="contact-name">
       ...
       <p id="contact-name"> Anonym </p>
   </div>

   <div class="contact">
      <p class="kontaktperson"> Email</p>
      <p id="contact-email"> Ingen email </p>
   </div>
