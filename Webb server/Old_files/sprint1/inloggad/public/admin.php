...
?>
    ...
    <table class="kommun-meny">          
            <tr><td class="kommun-val-header" ><a href="registerAsAdmin.php">Lägg till användare </a></td><td class="kommun-val-header"><a href="deleteMeny.php">Ta bort användare</a></td><td class="kommun-val-header"><a href="listUsers.php">Lista användare</a></td></tr>
